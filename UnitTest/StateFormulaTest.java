...
public class StateFormulaTest {
    ...
    private static ConstraintLabeledTransitionSystem testCase1()
    {
        ...
        nc1 = new NetworkConstraint();
        nc1.add(new Pair("C","A",false));nc1.add(new Pair("C","D",false));
...
public static ConstraintLabeledTransitionSystem testCase5()
{
    ...
    nc1 = new NetworkConstraint();
    nc1.add(new Pair("D","B",true));nc1.add(new Pair("D","C",false));
...
public static ConstraintLabeledTransitionSystem testCase8()
{
    ...
    nc1 = new NetworkConstraint();
    nc1.add(new Pair("D","A",false));nc1.add(new Pair("D","B",false));nc1.add(new Pair("D","C",true));
    g.addEdge(v1, v2, new LabeledTransition(new Label(nc1, "tau")));

    nc1 = new NetworkConstraint();
    nc1.add(new Pair("C","A",true));nc1.add(new Pair("C","D",true));nc1.add(new Pair("C","B",false));
    g.addEdge(v2, v3, new LabeledTransition(new Label(nc1, "tau")));
    
    nc1 = new NetworkConstraint();
    nc1.add(new Pair("C","A",true));nc1.add(new Pair("C","B",true));nc1.add(new Pair("C","D",false));
    g.addEdge(v2, v4, new LabeledTransition(new Label(nc1, "tau")));
    
    nc1 = new NetworkConstraint();
    nc1.add(new Pair("D","A",true));nc1.add(new Pair("D","B",true));nc1.add(new Pair("D","C",false));
    ...
    nc1 = new NetworkConstraint();
    nc1.add(new Pair("B","A",false));nc1.add(new Pair("B","C",false));nc1.add(new Pair("B","D",false));
    g.addEdge(v6, v8, new LabeledTransition(new Label(nc1, "tau")));

    nc1 = new NetworkConstraint();
    nc1.add(new Pair("B","C",true));nc1.add(new Pair("B","A",false));nc1.add(new Pair("B","D",false));
